#ifndef CAFFE_SIGMOID_CROSS_ENTROPY_FOCAL_LOSS_LAYER_HPP_
#define CAFFE_SIGMOID_CROSS_ENTROPY_FOCAL_LOSS_LAYER_HPP_
...
class SigmoidCrossEntropyFocalLossLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidCrossEntropyFocalLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SigmoidCrossEntropyFocalLoss"; }

 protected:
  /// @copydoc SigmoidCrossEntropyFocalLossLayer
  ...
  //Blob used to hold the input values after they have been scaled by scale_
  Blob<Dtype> scale_data_;
  Dtype scale_;
